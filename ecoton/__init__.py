...
__all__ = [
    ...
    "niche_unassigned_transcript_stats",
    "connected_components_from_selected_bins",
...
_EXPORT_TO_MODULE = {
    ...
    "niche_unassigned_transcript_stats": ".statistics_niche_maps",
    "connected_components_from_selected_bins": ".statistics_niche_maps",
    ...
    "plot_modules": ".plot_colocalization_modules",
